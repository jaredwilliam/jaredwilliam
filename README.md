...
- 🌱 I’m currently learning about computational thinking in Python through an MIT edX course. I am also currently taking Andrew Ng's Machine Learning course with MATLAB, but have given myself the extra challenge of doing the projects in Python. My inspiration for taking these courses is to really nail down the foundational aspects of programming, data science, and machine learning in Python to solve interesting problems. 
